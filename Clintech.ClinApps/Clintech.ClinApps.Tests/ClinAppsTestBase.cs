...
namespace Clintech.ClinApps.Tests
{
    public abstract class ClinAppsTestBase : AbpIntegratedTestBase
    {
        protected ClinAppsTestBase()
        {
            //Seed initial data
        ...
        public void UsingDbContext(Action<ClinAppsDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<ClinAppsDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<ClinAppsDbContext, T> func)
        {
            T result;
