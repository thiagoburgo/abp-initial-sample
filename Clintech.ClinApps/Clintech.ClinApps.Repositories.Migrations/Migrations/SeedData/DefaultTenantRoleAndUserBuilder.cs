...
using StaticRoleNames = Clintech.ClinApps.Domain.Entities.Authorization.StaticRoleNames;
...
namespace Clintech.ClinApps.Repositories.Migrations.Migrations.SeedData
{
    public class DefaultTenantRoleAndUserBuilder
    {
        ...
        public DefaultTenantRoleAndUserBuilder(ClinAppsDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateUserAndRoles()
        {
            ...
            if (adminRoleForHost == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new ClinAppsAuthorizationProvider())
