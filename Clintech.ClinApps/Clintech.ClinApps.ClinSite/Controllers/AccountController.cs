...
using Clintech.ClinApps.ClinSite.Controllers.Results;
using Clintech.ClinApps.ClinSite.Models.Account;
...
{
    public class AccountController : ClinSiteControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Domain.Entities.Users.User.CreateRandomPassword();
